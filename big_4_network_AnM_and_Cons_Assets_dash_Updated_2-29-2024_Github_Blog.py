...
#-------------------Dataframes for consolidated assets tabs-------------------------
#Dataframe for the Big Four banks scatter plot (consolidated assets)
big_four_lin_reg=pd.read_csv('https://raw.githubusercontent.com/juanchok12/Concentration-of-Banking/main/consolidated_asssets/melted_big_four_linear_reg.csv')

#Dataframe for the regression line of the Big Four banks (consolidated assets)
lin_reg_df=pd.read_csv('https://raw.githubusercontent.com/juanchok12/Concentration-of-Banking/main/consolidated_asssets/regression_line_data.csv')
...
# Row for Dropdown and Toggle================================================
    ...
    ''', 
     ...
     style={'padding': '1px', 
        ...
        dcc.Tab(label='Consolidated Assets',
                style={'backgroundColor': '#121212', 'color': '#FFFFFF', 'height': '30px','display':'block'},
                selected_style={'height': '40px'},
                children=[
            html.Div([
        #First row of the plots
                html.Div([
                    html.Iframe(id='lin-reg-plot',
                                src="//plotly.com/~juanchojuaninski/60.embed",
                                style={'width': '100%', 'height': '400px'}),
                    html.Iframe(id='treemap-plot',
                                src="//plotly.com/~juanchojuaninski/48.embed",
                                style={'width': '100%', 'height': '400px'}),
                ], style={'display': 'flex', 'width': '100%', 'justify-content': 'space-between'}),
        # Second row of iframes
                html.Div([
                    html.Iframe(id='lin-reg-plot-3',
                                src="//plotly.com/~juanchojuaninski/44.embed",
                                style={'width': '100%', 'height': '400px'}),
                    html.Iframe(id='lin-reg-plot-4',
                                src="//plotly.com/~juanchojuaninski/42.embed",
                                style={'width': '100%', 'height': '400px'}),
                ], style={'display': 'flex', 'width': '100%', 'justify-content': 'space-between'}),
        ],) 
            ]) 

...
html_dir=r"C:\User\Name\Your\Local\Directory\Here\html_files"
csv_dir=r"C:\User\Name\Your\Local\Directory\Here\csv_files"

#============================Websraping & File Conversion=======================================================
...
def read_specific_table(html_file):
    with open(html_file, 'r', encoding='utf8') as file:  # It's a good practice to define encoding
        ...
        #Define a function to use with find_all that allows for OR logic
...
dataset_dir=r"C:\User\Name\Your\Local\Directory\Here\datasets" #This is where you will save your datasets to then be uploaded to Github
...
def process_data(csv_files, csv_dir):
    ...
    concatenated_df.to_csv("C:\\User\\Name\\Your\\Local\\Directory\\Here\\csv_files\\concatenated_df.csv")
...
def get_file_sha(repo, path, filename, token):
    """Retrieve the SHA of an existing file on GitHub to allow updates."""
...
def upload_to_github(repo, path, token, file_path):
    ...
    file_sha = get_file_sha(repo, path, filename, token)  # Get the SHA if file exists
    ...
    if file_sha:  # If file exists, include the SHA to update it
        data['sha'] = file_sha
...
# Example usage
file_paths = [
    r"C:\User\Name\Your\Local\Directory\Here\datasets\bank_asset_line.csv",
    r"C:\User\Name\Your\Local\Directory\Here\datasets\bank_asset_scatter.csv",
    r"C:\User\Name\Your\Local\Directory\Here\datasets\bank_asset_treemap.csv",
    r"C:\User\Name\Your\Local\Directory\Here\datasets\bank_asset_percentage.xlsx",
            ]

upload_multiple_files('username/repository-name', 'rep_folder_name', 'personal access token here', file_paths)
